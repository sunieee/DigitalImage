...
def extract_curve_points(
    ...
    """Extract curve data points from one image and return CSV and interpolation plot paths."""
...
def split_horizontal_images(
    ...
    """Horizontally split all input images and return generated output paths."""
    if not image_paths:
